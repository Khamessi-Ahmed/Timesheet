...
@Component({
  ...
  templateUrl: './man-project.component.html',
  styleUrl: './man-project.component.css'
})
export class ManProjectComponent implements OnInit {
  projects: any[] = [];
  ...
  loadAllProjects(): void {
    this.isLoading = true;
    this.projectService.getProjectsByManager(this.currentManagerId).subscribe({
      next: (projects) => {
